...
export default function Edit({ departamento, departamentos }: PageProps<{ departamento: Departamento; departamentos: Departamento[] }>) {
    ...
    return (
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Editar Departamento</h2>
            }
        >
