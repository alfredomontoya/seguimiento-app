...
export default function Edit({ usuario, roles }: PageProps<{ usuario: Usuario; roles: Rol[] }>) {
    ...
    return (
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800">Editar Usuario</h2>
            }
        >
                ...
                <div className="mx-auto max-w-2xl sm:px-6 lg:px-8">
                    <div className="bg-white p-6 shadow sm:rounded-lg">
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div>
                                <InputLabel htmlFor="password" value="Contraseña (dejar vacío para mantener)" />
