                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <form onSubmit={submit} className="p-6">
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    <InputLabel htmlFor="funcionario_id" value="Funcionario (opcional)" />
                                    <ComboboxInput
                                        ...
                                        onChange={(val) => setData('funcionario_id', val.toString())}
                                        placeholder="Sin funcionario"
                                    />
                                    <InputError message={errors.funcionario_id} className="mt-2" />
                                </div>
                            </div>
