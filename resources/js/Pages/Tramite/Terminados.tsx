...
export default function Terminados({ tramites }: { tramites: PaginatedData }) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Trámites Terminados</h2>}
        >
            {' '}
            <Head title="Trámites Terminados" />{' '}
            <div className="py-2">
                {' '}
                <div className="w-full">
                    ...
                    <div className="mb-6 flex items-center justify-between">
                        ...
                        <p className="text-sm text-gray-600">
                            {' '}
                            Trámites en estado <span className="font-semibold">terminado</span> o{' '}
                    ...
                    <DataTable
                        ...
                        columns={columns}
                        meta={tramites}
                        emptyMessage="No hay trámites terminados."
                    />{' '}
                </div>{' '}
            </div>{' '}
        </AuthenticatedLayout>
