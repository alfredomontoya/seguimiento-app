...
export default function Pendientes({ tramites }: { tramites: PaginatedData }) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Trámites Pendientes</h2>}
        >
            {' '}
                ...
                <div className="w-full">
                    ...
                    <div className="mb-6 flex items-center justify-between">
                        ...
                        <p className="text-sm text-gray-600">
                            {' '}
                            Trámites en estado <span className="font-semibold">recibido</span> o{' '}
                            <span className="font-semibold">en_proceso</span>{' '}
                        </p>{' '}
                        <Link
                    ...
                    <DataTable
                        ...
                        columns={columns}
                        meta={tramites}
                        emptyMessage="No hay trámites pendientes."
                    />{' '}
                </div>{' '}
            </div>{' '}
        </AuthenticatedLayout>
